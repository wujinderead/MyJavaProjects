 ...
 * the MyPriorityBlockingQueue in any particular order. If you need
...
public class MyPriorityBlockingQueue<E> extends AbstractQueue<E>
    ...
    /**
     * Creates a {@code MyPriorityBlockingQueue} with the default
    ...
    /**
     * Creates a {@code MyPriorityBlockingQueue} with the specified
    ...
    /**
     * Creates a {@code MyPriorityBlockingQueue} with the specified initial
    ...
    /**
     * Creates a {@code MyPriorityBlockingQueue} containing the elements
     ...
     * a {@code MyPriorityBlockingQueue} is not capacity constrained.
