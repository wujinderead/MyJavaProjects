...
public class MyConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    ...
    public String toString() {
        ...
        while (hi != null) {
            builder.append("level "+ ((HeadIndex) hi).level + ": ");
            Index cur = hi;
            while (cur != null) {
                builder.append(cur.node.key+ " -> ");
                cur = cur.right;
            }
            hi = hi.down;
            builder.append("\n");
    ...
    static class Index<K,V> {
        ...
        /**
         * Tries to CAS
         * newSucc as successor.  To minimize races with
    ...
    /**
     * Returns a shallow copy of this {@code MyConcurrentSkipListMap}
