 ...
 * the MyDelayQueue in any particular order.
 *
...
public class MyDelayQueue<E extends Delayed> extends AbstractQueue<E>
    ...
    /**
     * Creates a new {@code MyDelayQueue} that is initially empty.
     */
    public MyDelayQueue() {}

    /**
     * Creates a {@code MyDelayQueue} initially containing the elements of the
     ...
     * a {@code MyDelayQueue} is not capacity constrained.
     *
